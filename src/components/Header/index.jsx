...
import resume from "./2023resume.pdf"
  ...
  return (
    <header ref={ref}>
      ...
      <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 0.5 }} className="header--top">
        <h3>
          <a href="https://github.com/NzyC" target={"_blank"} rel="noopener noreferrer">
            <ScrambleText shuffle delay={0.5}>
              GITHUB
            </ScrambleText>
          </a>
          <span className="header--hash">{"//"}</span>
          <a href="https://www.linkedin.com/in/nidal-chowdhury-b56b52220/" target={"_blank"} rel="noopener noreferrer">
      ...
      <h1 className="header--name">
        <TextWriting controls={controls} text={"Nidal Chowdhury"} noblink />
        <br />
