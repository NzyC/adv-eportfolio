  ...
  const works = [
    {
      ...
      detail: "An engaging ePortfolio developed using HTML, CSS, JavaScript, and React to showcase my skills offering a dynamic representation of my career journey.",
    },
    {
      client: "",
      year: "2022",
      img: work2,
      title: "HULM Studios Project",
      detail: "The website for Hulm Studios, a digital marketing agency, was meticulously developed using HTML, CSS, and JavaScript. Since then, I have been a part of a number of projects.",
    },
    {
      client: "",
      year: "2021",
      img: work3,
      title: "Twitter Clone",
      detail: "A Twitter clone web app built using Firebase v9 and React, integrating Firebase v9 Database and Twitter Embeds for content storage and feed fetching",
    },
  ]
